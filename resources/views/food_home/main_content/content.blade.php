    ...
    <div class="container">
        <div class="row justify-content-between gy-5">
            ...
            <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
                <img src="{{asset('Yummy/assets/img/hero-img.png')}}" class="img-fluid" alt="" data-aos="zoom-out"
                    data-aos-delay="300">
            </div>
        </div>
    </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
                <div class="col-lg-7 position-relative about-img"
                    style="background-image: url({{asset('Yummy/assets/img/about.jpg')}}) ;" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="row gy-5">
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{asset('Yummy/assets/img/menu/menu-item-1.png')}}" class="glightbox"><img
                                    src="{{asset('Yummy/assets/img/menu/menu-item-1.png')}}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Magnam Tiste</h4>
                            <p class="ingredients">
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{asset('Yummy/assets/img/menu/menu-item-2.png')}}" class="glightbox"><img
                                    src="{{asset('Yummy/assets/img/menu/menu-item-2.png')}}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Aut Luia</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{asset('Yummy/assets/img/menu/menu-item-3.png')}}" class="glightbox"><img
                                    src="{{asset('Yummy/assets/img/menu/menu-item-3.png')}}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Est Eligendi</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{asset('Yummy/assets/img/menu/menu-item-4.png')}}" class="glightbox"><img
                                    src="{{asset('Yummy/assets/img/menu/menu-item-4.png')}}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Eos Luibusdam</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{asset('Yummy/assets/img/menu/menu-item-5.png')}}" class="glightbox"><img
                                    src="{{asset('Yummy/assets/img/menu/menu-item-5.png')}}" class="menu-img img-fluid"
                                    alt=""></a>
                            <h4>Eos Luibusdam</h4>
                            <p class="ingredients">
                                Lorem, deren, trataro, filede, nerada
                        ...
                        <div class="col-lg-4 menu-item">
                            <a href="{{asset('Yummy/assets/img/menu/menu-item-6.png')}}" class="glightbox"><img
                                    src="{{asset('Yummy/assets/img/menu/menu-item-6.png')}}" class="menu-img img-fluid"
                                    alt=""></a>
    ...
    <section id="book-a-table" class="book-a-table">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-4 reservation-img" style="background-image: url({{asset('Yummy/assets/img/reservation.jpg')}});"
            ...
            <div class="gallery-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{asset('Yummy/assets/img/gallery/gallery-1.jpg')}}"><img src="{{asset('Yummy/assets/img/gallery/gallery-1.jpg')}}"
                                class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{asset('Yummy/assets/img/gallery/gallery-2.jpg')}}"><img src="{{asset('Yummy/assets/img/gallery/gallery-2.jpg')}}"
                                class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{asset('Yummy/assets/img/gallery/gallery-3.jpg')}}"><img src="{{asset('Yummy/assets/img/gallery/gallery-3.jpg')}}"
                                class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{asset('Yummy/assets/img/gallery/gallery-4.jpg')}}"><img src="{{asset('Yummy/assets/img/gallery/gallery-4.jpg')}}"
                                class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{asset('Yummy/assets/img/gallery/gallery-5.jpg')}}"><img src="{{asset('Yummy/assets/img/gallery/gallery-5.jpg')}}"
                                class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{asset('Yummy/assets/img/gallery/gallery-6.jpg')}}"><img src="{{asset('Yummy/assets/img/gallery/gallery-6.jpg')}}"
                                class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{asset('Yummy/assets/img/gallery/gallery-7.jpg')}}"><img src="{{asset('Yummy/assets/img/gallery/gallery-7.jpg')}}"
                                class="img-fluid" alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="{{asset('Yummy/assets/img/gallery/gallery-8.jpg')}}"><img src="{{asset('Yummy/assets/img/gallery/gallery-8.jpg')}}"
                                class="img-fluid" alt=""></a></div>
                </div>
                <div class="swiper-pagination"></div>
            </div>
